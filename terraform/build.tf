...
module "network" {
  ...
  subnet_service_endpoints = {
    ...
    "sn2-${module.network.vnet_name}" = ["Microsoft.Storage", "Microsoft.Sql", "Microsoft.Network/dnsResolvers"], // Adds extra subnet endpoints to sn2-vnet-ldo-euw-dev-01
    "sn3-${module.network.vnet_name}" = ["Microsoft.AzureActiveDirectory", "Microsoft.Network/dnsResolvers"]      // Adds extra subnet endpoints to sn3-vnet-ldo-euw-dev-01
  }
}
